...
/*
  ...
  Enable #130 "Custom check" to find a dot in street names, but allow dots at Ramps:
    ...
    *Note: do not forget to escape backslashes in strings, i.e. use "\\" instead of "\".
    ...
    2.4 - Add extra language header to fix working in localized WME.
*/
...
window.WME_Validator_United_States = {
    ...
    "130.enabled": true,
    "130.title": "Not TX, OK, MS, LA, AR",
    "130.problem": "The segment is assigned to another state",
    "130.solution": "Make sure you are editing in TX, OK, MS, LA, or AR, and change it or disable script when working in another state",
    "130.params": {
        "template": "${state}",
    ...
    "132.problem": "TX & OK uses CR for county road, SH for state highway, US for national highway, and I for interstate names",
    ...
    "133.title": "Wrong road type (freeway/major/minor/PS)",
    "133.problem": "All non-BUS/SPUR/LOOP Interstates should be Freeway. All BUS/SPUR/LOOP Interstates and non-BUS/SPUR/LOOP US Highways should be at least Major Highway. All BUS/SPUR/LOOP US Highways and non-BUS/SPUR/LOOP State Highways should be at least Minor Highway. All BUS/SPUR/LOOP State Highways should be at least Primary Street.",
    "133.solution": "Change the road type to Freeway or Major Highway",
    "133.params": {
    ...
    "136.enabled": true,
    "136.title": "Tulsa Metro: Incorrect Street Name Format",
    "136.problem": "Tulsa Metro Street Types: N/S Segments should not have East/West abbreviated. E/W Segments south of Admiral and East of Main should not have trailing 'S' or 'South'. (Excludes ramps)",
    "136.solution": "Rename the Street or Alt Street",
    "136.params": {
